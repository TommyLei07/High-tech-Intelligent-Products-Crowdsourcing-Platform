	...
	<table class="addPictureTable" align="center">
		<tr>
			<td class="addPictureTableTD">
			  <div>
				<div class="panel panel-primary addPictureDiv">
					<div class="panel-heading">新增众筹产品单个图片</div>
					  <div class="panel-body">
					    	<form method="post" class="addFormSingle" action="foreprojectimgadd" enctype="multipart/form-data">
					    		<table class="addTable">
					    			<tr>
					    				<td>请选择本地图片尺寸400X400 为佳</td>
					    			</tr>
					    			<tr>
					    				<td>
						...
						<c:forEach items="${pisSingle}" var="pi">
							<tr>
								...
								<td><a deleteLink="true"
									href="foreprojectimgdelete?id=${pi.id}"><span
			...
			<td class="addPictureTableTD">
			  <div>
				...
				<div class="panel panel-primary addPictureDiv">
					<div class="panel-heading">新增众筹产品详情图片</div>
					  <div class="panel-body">
					    	<form method="post" class="addFormDetail" action="foreprojectimgadd" enctype="multipart/form-data">
					    		<table class="addTable">
					    			<tr>
